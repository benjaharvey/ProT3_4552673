...
<main>
    ...
    <h1>¿Quienes forman parte del Aeroclub Cañada Quiroz?</h1>
    <p class="subtitulo-2">Aqui estan algunos de los miembros que pertenecen al Aeroclub Cañada Quiroz, quienes son, desde cuando son miembros y que rol ejercen</p>

      <div class="container mt-4 imagenes-miembros">
    <div class="row">
  ...
  <h2>Eventos en el Aeroclub Cañada Quiroz</h2>
  <p class="subtitulo-2">En el Aeroclub se llevan a cabo de forma regular diversos eventos sociales, como encuentro de aviación civil, cumpleaños, clases de formación tecnica para pilotos y tambien entrenamiento para los bomberos voluntarios de la provincia de Corrientes</p>
