...
<main>
    ...
    <p class="text-center fs-5">El Aeroclub Cañada Quiroz, ubicado en Corrientes, Argentina, es un centro de aviación que ofrece una amplia gama de servicios para entusiastas de la aviación y la comunidad en general. Fundado en 2023, el aeroclub se ha convertido en un referente para quienes buscan aprender a volar, disfrutar de vuelos panorámicos o simplemente compartir la pasión por la aviación.</p>


    <div class="container bg-light p-4 rounded-4 shadow contenedor-escuela">

      <h2 style="margin-bottom: 2em;">Servicios para socios</h2>

     <p class="text-center fs-5">El Aeroclub ofrece una diversidad de servicios para sus socios. Los socios del aeroclub disfrutan de acceso a las facilidades del club en Riachuelo, que cuenta con parrillas y un gran espacio verde para la realización de actividades como aeromodelismo. Ademas, los socios del aeroclub pueden acceder a la posibilidad de guardar sus aviones en los hangares del aeroclub, asi tambien como utilizar el avión del aeroclub, siempre y cuando paguen las horas de vuelo que vayan a realizar</p>

        <div class="row">
            <div class="col-md-4">
                <h4>Avion del aeroclub</h4>
    ...
    <h2>Servicios disponibles para socios y no socios</h2>
    <p class="text-center fs-5">Los siguientes servicios listados estan disponibles para todo publico, los socios disfrutan de generosos descuentos si desean acceder a los servicios aquí listados</p>

    <div class="container bg-light p-4 rounded-4 shadow contenedor-escuela">
        <div class="row">
            <div class="col-md-4">
                <h4>Escuela de vuelo</h4>
                <p>La Escuela de Vuelo del Aeroclub Cañada Quiroz nació en 2023 con una misión clara: formar nuevos pilotos con pasión, responsabilidad y mucha dedicación. Acá no solo aprendés a volar, sino que vivís la aviación desde adentro, acompañado por instructores con experiencia que te guían paso a paso.Ofrecemos clases teóricas tanto virtuales como presenciales, adaptándonos a tu ritmo y disponibilidad. 
                  El aula está equipada en el radioclub de la ciudad de Corrientes, en un entorno tranquilo e ideal para aprender con comodidad. Y cuando llega el momento de despegar, los vuelos de instrucción se hacen en un ambiente seguro, pensado para que ganes confianza desde el primer día.
        ...
        <div class="row">
            <div class="col-md-4">
                <h4>Vuelos Panoramicos</h4>
                <p>¿Alguna vez imaginaste ver Corrientes desde el cielo? Con nuestros vuelos panorámicos podés hacerlo realidad. Te llevamos a disfrutar de una vista única de la ciudad, perfecta para una salida distinta en pareja, en familia o con amigos.
                  Es una experiencia distinta, emocionante y segura, donde podés sacar fotos, filmar o simplemente relajarte y dejarte sorprender por la vista.
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p>Desde 2022, en el Aeroclub Cañada Quiroz contamos con un simulador de vuelo de última generación, habilitado por la ANAC, que usamos tanto para enseñar como para entrenar. Es una herramienta clave que ayuda a nuestros alumnos a ganar experiencia desde un entorno seguro antes de subirse al avión real.
    ...
    <h2 style="margin-bottom: 1em;">Contacto</h2>

    <p class="text-center fs-5">¿Tenés alguna duda o querés consultar el precio de la membresía al club?
    No dudes en enviarnos un mensaje. Estamos para ayudarte y tu consulta no es una molestia.</p>
    ...
    <div class="card-body rounded-4 shadow">
      <form>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="mensaje" rows="4" placeholder="Escribí tu consulta o mensaje..."></textarea>
        </div>

        <button type="submit" class="btn me-2 boton-registrar">Enviar</button>
