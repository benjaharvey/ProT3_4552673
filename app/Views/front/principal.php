    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          ...
          <button type="button" class="btn boton-sobre-nosotros">
            <a class="nav-link active" aria-current="page" href="miembros-aeroclub.php">Acerca de</a>
          </button>
        ...
        <li class="nav-item dropdown">
           ...
           <button type="button" class="btn boton-servicios">
            ...
            <li><a class="dropdown-item" href="servicios.php">Escuela de vuelo</a></li>
            <li><a class="dropdown-item" href="servicios.php">Simulador de vuelo</a></li>
            <li><a class="dropdown-item" href="servicios.php">Vuelos sobre la Ciudad de Corrientes</a></li>
          </ul>
          </button>
        </li>
      </ul>
      ...
      <form class="d-flex" role="search">
        ...
        <button type="button" class="btn boton-inicio-sesion">
          <a class="nav-link active" aria-current="page" href="iniciar-sesion.php">Iniciar Sesión</a>
        </button>
...
<main>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="imagenes/fotos-aeroclub/aeroclub1.png" class="d-block mx-auto img-aeroclub1" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <p class ="texto-descripcion">Un fin de semana cualquiera el aeroclub!</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="imagenes/fotos-aeroclub/aeroclub2.png" class="d-block mx-auto img-aeroclub2" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <p class ="texto-descripcion">Some representative placeholder content for the second slide.</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="imagenes/fotos-aeroclub/aeroclub3.png" class="d-block mx-auto img-aeroclub3" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <p class ="texto-descripcion">Some representative placeholder content for the third slide.</p>
      </div>
    </div>
  </div>
...
<div class="container my-5">
  <div class="row justify-content-center">
    <div class="col-md-6 col-lg-4 mb-4">
      <div class="card h-100">
        <img src="imagenes/escuela-vuelo/escuela-vuelo1.png" class="card-img-top" alt="Escuela de vuelo">
        <div class="card-body">
    ...
    <div class="col-md-6 col-lg-4 mb-4">
      <div class="card h-100">
        <img src="imagenes/simulador-vuelo/escuela de vuelo2.png" class = "card-img-top" alt="Simulador de vuelo">
        <div class="card-body">
  ...
  <div class="row justify-content-center">
    <div class="col-md-8 col-lg-6">
      <div class="card h-100">
        <img src="imagenes/vuelos-panoramicos/vuelo-panoramico5.png" class="card-img-top" alt="Vuelos panorámicos">
        <div class="card-body">
